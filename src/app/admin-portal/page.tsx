        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between items-center py-4">
            <div>
              ...
              <p className="text-gray-600">GasFeel Content Challenge - Demo Mode</p>
            </div>
      ...
      <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div className="glass-card backdrop-blur-md bg-white/70 border border-white/90 shadow-lg p-4 mb-8 text-center">
          <p className="text-charcoal font-medium">
            ...
            Demo data loaded - no authentication required.
          </p>
        </div>
          ...
          <div className="p-6">
            <div className="flex justify-between items-center mb-6">
              <h2 className="text-xl font-semibold text-charcoal">
                AI Submissions (Demo Data)
              </h2>
              <div className="text-sm text-gray-600">
                {submissions.length} demo submissions
              </div>
            </div>
        ...
        <div className="glass-card backdrop-blur-md bg-white/70 border border-white/90 shadow-lg p-6 mt-8">
          <h3 className="text-lg font-semibold text-charcoal mb-4">Demo Instructions</h3>
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            <div>
              <h4 className="font-medium text-charcoal mb-2">Features Demonstrated</h4>
              <ul className="space-y-1 text-sm text-gray-600">
                ...
                <li>• Late submission detection and marking</li>
              </ul>
            </div>
            <div>
              <h4 className="font-medium text-charcoal mb-2">Demo Data</h4>
              <ul className="space-y-1 text-sm text-gray-600">
                <li>• 1 Pending submission (JohnA1B2)</li>
                <li>• 1 Approved submission (JaneC3D4)</li>
                <li>• 1 Rejected submission (BobE5F6)</li>
        ...
        <div className="glass-card backdrop-blur-md bg-white/70 border border-white/90 shadow-lg p-6 mt-8">
          <h3 className="text-lg font-semibold text-charcoal mb-4">Production Setup</h3>
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            <div>
              <h4 className="font-medium text-charcoal mb-2">Backend Requirements</h4>
              <ul className="space-y-1 text-sm text-gray-600">
                <li>• Set up Supabase database with schema from BACKEND_SETUP.md</li>
                <li>• Configure environment variables for Supabase</li>
                <li>• Configure password-based authentication</li>
                <li>• Deploy API endpoints to production</li>
              </ul>
            </div>
            <div>
              <h4 className="font-medium text-charcoal mb-2">Admin Features</h4>
              <ul className="space-y-1 text-sm text-gray-600">
                <li>• Contest controls (freeze/unfreeze display)</li>
                <li>• Status management (live/verification/final)</li>
                <li>• Publish final results functionality</li>
